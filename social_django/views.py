...
def complete(request, backend, *args, **kwargs):
    ...
    dos = do_complete(request.backend, _do_login, request.user,
...
class AuthUser():
    ...
    def set_password(self, password):
        self.UserModels.set_password(password)
        self.save()
        pass

    def set_email(self, email):
        self.UserModels.email = email
        self.save()
        pass

    def set_user(self, username):
        self.UserModels.username = username
        self.save()
        pass

    def save(self):
        self.UserModels.save()
        pass
...
def auth_password(request):
    ...
    if request.method == 'POST':
        ...
        USA = UserSocialAuth.objects.filter(user__username=username, defaule=False)
        if USA:
            ...
            Au = AuthUser(username=username, email=email)
            Au.set_password(password=password)
            Au.set_email(email=email)
