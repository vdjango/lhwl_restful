(function () {
    ...
    var Upload = {
        ...
        config: function (sel) {
            ...
            url=url + (url.indexOf("?") == -1 ? "?" : "&") + "editorid="+me.editor.id+"&unix="+unix;//初始form提交地址;
                ...
                me.dialog.find('.edui-image-content').on('drop',function (e) {
                    ...
                    $.each(fileList, function (i, f) {
                        if (/^image/.test(f.type)) {
                            ...
                            xhr.open("post", me.editor.getOpt('imageUrl') + "?type=ajax&unix=" + unix, true);
